	...
	show(OFF){
		...
		let oldx, oldy;
			for(let i=0;i<this.length;i++){
				let z = noise(this.zseed+(i*0.005))*(this.waviness)+this.z-(this.waviness/2);
				let x = noise(this.xseed+(i*0.005))*(this.waviness)+this.x-(this.waviness/2);
				let y = noise(this.yseed+(i*0.005))*(this.waviness)+this.y-(this.waviness/2);
